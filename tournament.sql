...
CREATE TABLE matches (match_id serial PRIMARY KEY, winning_player_id integer REFERENCES players(player_id), losing_player_id integer REFERENCES players(player_id));
